...
from csl.graph.Edges import Edges
from csl.graph.Endpoint import Endpoint
from csl.graph.Graph import Graph
from csl.graph.Node import Node
from csl.graph.NodeType import NodeType
import pydot
...
class GraphUtils:
    ...
    def to_pydot(G: Graph, edges: List[Edge] | None = None, labels: List[str] | None = None, title: str = "", dpi: float = 200):
        ...
        # print("Lk test")
        # pydot_g.write_png('result/LK_simple_test.png')
